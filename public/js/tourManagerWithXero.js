    ...
    window.tour = new Tour({
        steps: [
            ...
            },
            {
                ...
                placement: "left",
                content: 'To create the highest level of your organisation structure, click "create". Enter the name and press "save". <br><br>'
            ...
            },
            {
                ...
                title: "Xero Setting",
                placement: "left",
                content: "Connect with your Xero account and select relevant company (if more than one company). " + "<br><br>" +
                        "You can select the staff members you want to invite during Xero synchronize process.  ",
                backdrop: true,
                backdropContainer: ".right-sidebar",
                onPrev: function (tour) {
                    $('#sickleaves_setting').click();
