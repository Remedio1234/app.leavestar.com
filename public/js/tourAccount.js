    ...
    window.tour = new Tour({
        steps: [
            ...
            },
            {
                ...
                placement: "right",
                content: "This is the Sidebar. You can moniter your leave capacity here. A leave countdown will be shown if any of your leave has been approved. As a manager, you could also manage your staff and their leave applications. You could change your organisations' setting here as well. ",
                backdrop: true,
            ...
            },
            {
                ...
                placement: "left",
                content: 'By click "Apply for Leave" on the sidebar,leave application page will be opened. You can apply a leave application here.',
                backdrop: true,
