                    ...
                    <div class="left_from_db col-md-6" style=" max-height: 700px; overflow: auto;">
                        ...
                        <div>
                            <table class="table table-striped">
                                ...
                                <tr>
                                    <td>
                                        <input type="checkbox" id="skipsychronize" value="true" <?= (isset($_SESSION['DBUsers'][$_SESSION['step']]['skipsychronize']) && ($_SESSION['DBUsers'][$_SESSION['step']]['skipsychronize'] == true)) ? "checked" : "" ?>> Do not sychronize this user to Xero.
                                    </td>
                                </tr>
                            </table>
                            <?php
