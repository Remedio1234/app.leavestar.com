...
<div class="container1 container-fluid">
    <div class="row">
        <div class="right_from_xero col-md-12" style=" max-height: 700px; overflow: auto;">
            ...
            {!! Form::open(['action' => 'XeroController@Invite','method'=>'post','class'=>'invitation']) !!} 
...
//                    $disable = (isset($item['Email'])) ? "" : "Disabled";
                    ...
                    //$orgSearch = ($userregisted) ? \App\Models\OrganisationStructure::find($userregisted->org_id)->id : "";
                    ?>
                    <tr>
                        <td>
...
<script>
    $(function () {
        ...
        $("body").on("click", "#select-all-invite", function () {
