...
<div class="content-normal">
    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            <div class="row">
                {!! Form::model($leaveAccrualSetting,['action' => 'LeaveAccrualSettingController@StoreSetting'  ]) !!}

                <!-- Period Field -->
                <div class="form-group col-sm-12">
                    {!! Form::label('leave type id', 'Leave Type:') !!}
                    <?= \App\Models\LeaveType::find($leaveAccrualSetting->leave_type_id)->name ?>
                </div>
                ...
                <?php $cap = isset($capacity) ? $capacity->capacity : "" ?>

                <div class="form-group col-sm-12">
                    {!! Form::label('balance', 'Current Balance:') !!}
                    {!! Form::text('balance',  $cap, ['class' => 'form-control' ,'placeholder'=>'Hours']) !!}
                </div>
                ...
                <div class="form-group col-sm-12">
                    {!! Form::hidden('leave_type_id', $leaveAccrualSetting->leave_type_id , ['class' => 'form-control']) !!}
                </div>
