...
<section class="content-header">
    ...
    <h1 class="pull-right">
        ...
        <a class="btn btn-primary pull-right button-open-right" style="margin-top: -10px;margin-bottom: 5px" href="javascript:return false;" data-href=<?= "/leaveTypes/create?org_id=" . $organisationStructure->id ?>>Add New</a>
    </h1>
</section>
<div class="content">
